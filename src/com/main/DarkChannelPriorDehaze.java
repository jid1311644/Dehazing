...
public class DarkChannelPriorDehaze {
	...
	public DarkChannelPriorDehaze(String path) {
		// TODO Auto-generated constructor stub
		this.path = path;
	}
	
	public DarkChannelPriorDehaze() {
		// TODO Auto-generated constructor stub
	}
	
	public Mat darkChannelPriorDehaze(Mat image) {
		
        Mat result = enhance(image, krnlRatio, minAtmosLight, eps);
		
        return result;
		
	}

	public void darkChannelPriorDehaze() {
		
		Mat image = Imgcodecs.imread(path, Imgcodecs.CV_LOAD_IMAGE_COLOR);
        Mat result = enhance(image, krnlRatio, minAtmosLight, eps);
		
        int dot = path.lastIndexOf('.');
		String fileName = path.substring(0, dot) + "_DEHAZE";
	...
	public Mat enhance(Mat image, double krnlRatio, double minAtmosLight, double eps) {
...
//		
//		DarkChannelPriorDehaze dehaze = new DarkChannelPriorDehaze("./resources/train.bmp");
//		dehaze.darkChannelPriorDehaze();
//		
//		System.out.println("DEHAZING OK");
//		
//	}
